...
app.get("/api/users", requireAuth, requireAdmin, async (req, res) => {
  try {
    const result = await pool.query(
      "SELECT id, full_name, email, role, created_at, is_frozen, freeze_reason, withdrawals_disabled, withdrawal_disable_reason, deposits_disabled, deposit_disable_reason FROM users ORDER BY id DESC"
);
